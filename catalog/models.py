...
class Genre(models.Model):
    ...
    def __str__(self):
        """
        Cadena que representa a la instancia Genero
        """
        return self.name
...
class BookInstance(models.Model):
    ...
    #Es primary key porque es un identificador unico para cada libro de la biblioteca

    book = models.ForeignKey('Book', on_delete=models.SET_NULL, null=True) 
    #Foregn Key porque una copia solo tiene un libro pero un libro puede tener varias copias

    imprint = models.CharField(max_length=200)

    due_back = models.DateField(null=True, blank=True)
    # fecha en la que se espera que el libro este diponible despues de ser prestado o estar en mantenimiento
    ...
    def __str__(self):
        """
        String para representar el Objeto Copia de libro
        """
